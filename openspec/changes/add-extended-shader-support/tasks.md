...
- [ ] 1.1 Add `#reference` directive detection before INI parsing
- [ ] 1.2 Implement recursive reference loading with depth limit (max 8)
- [ ] 1.3 Add path cycle detection to prevent infinite loops
- [ ] 1.4 Parse `frame_count_modN` per-pass into PassConfig
- [ ] 1.5 Resolve relative paths for referenced presets

## 2. Frame History Ring Buffer

- [ ] 2.1 Add FrameHistory struct with circular buffer (MAX_HISTORY = 7)
- [ ] 2.2 Integrate FrameHistory into FilterChain
...
- [ ] 3.1 Bind OriginalHistory[0-6] textures by sampler name pattern
- [ ] 3.2 Add OriginalHistorySize[0-6] push constant population
- [ ] 3.3 Apply frame_count_mod to FrameCount in SemanticBinder
