...
#define GOGGLES_LOG_TRACE(...) \
    SPDLOG_LOGGER_TRACE(::goggles::get_logger(), __VA_ARGS__)

#define GOGGLES_LOG_DEBUG(...) \
    SPDLOG_LOGGER_DEBUG(::goggles::get_logger(), __VA_ARGS__)

#define GOGGLES_LOG_INFO(...) \
    SPDLOG_LOGGER_INFO(::goggles::get_logger(), __VA_ARGS__)

#define GOGGLES_LOG_WARN(...) \
    SPDLOG_LOGGER_WARN(::goggles::get_logger(), __VA_ARGS__)

#define GOGGLES_LOG_ERROR(...) \
    SPDLOG_LOGGER_ERROR(::goggles::get_logger(), __VA_ARGS__)

#define GOGGLES_LOG_CRITICAL(...) \
    SPDLOG_LOGGER_CRITICAL(::goggles::get_logger(), __VA_ARGS__)
